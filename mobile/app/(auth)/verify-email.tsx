      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <View className="flex-1 bg-gray-50">
          ...
          >
            ...
            {/* OTP Input */}
            <View className="mt-6 bg-white rounded-2xl px-4 py-6 border border-gray-100 space-y-4">
              <View>
                <Text className="text-sm font-medium text-gray-700 mb-2">
                  Doğrulama Kodu
                </Text>
                <TextInput
                  className="border border-gray-300 rounded-xl px-4 py-3 text-center text-2xl font-bold tracking-widest bg-gray-50"
                  placeholder="000000"
                  value={otp}
              ...
              {/* Resend Section */}
              <View className="mt-4">
                <Text className="text-center text-gray-600 mb-2 text-sm">
                  Kod gelmedi mi?
                </Text>
                {canResend ? (
                  <TouchableOpacity
                    ...
                    className="py-2"
                  >
                    <Text className="text-center font-semibold text-emerald-600 text-sm">
